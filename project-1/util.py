...
class Node:
    ...
    '''Constructor for a Node object.
        ...
        Attributes:
            state (State): Coordinates of the current node, in this case
            pathCost (int): The path cost of this node
            parent (Node): a reference to the parent of this node
            action (game.Directions): the action last taken to reach this node
        
        '''
    def __init__(self, state, action, pathCost, parentNode):
        '''
        Args:
            state (State): Coordinates of the current node, in this case
            pathCost (int): The path cost of this node
    ...
    def getPathCost(self):
        "Returns the path cost of node"
        return self.pathCost

    def getState(self):
        "Returns state of node (location on grid)"
        return self.state
